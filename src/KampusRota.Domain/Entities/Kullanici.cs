...
namespace KampusRota.Domain.Entities
{
    public class Kullanici : BaseEntity
    {
        ...
        public string Rol { get; set; } = "Student";

        public int? UniversityId { get; set; }
        public virtual University? University { get; set; }

        public virtual ICollection<Yolculuk> SurucuYolculuklari { get; set; } = new List<Yolculuk>();
        public virtual ICollection<YolculukTalebi> Talepleri { get; set; } = new List<YolculukTalebi>();
    }
}
